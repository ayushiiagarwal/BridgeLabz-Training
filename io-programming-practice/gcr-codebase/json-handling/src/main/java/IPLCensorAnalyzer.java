...
public class IPLCensorAnalyzer {
    ...
    private static void censorJson() throws Exception {
        String content = new String(Files.readAllBytes(Paths.get("files/ipl.json")));
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            object.put("team1", maskTeamName(object.getString("team1")));
            object.put("team2", maskTeamName(object.getString("team2")));
            object.put("winner", maskTeamName(object.getString("winner")));

            object.put("player_of_match", redactPlayer());
        ...
        try (FileWriter writer = new FileWriter("files/censored.json")) {
    ...
    private static void censorCsv() throws Exception {
        ...
        List<String> lines = Files.readAllLines(Paths.get("files/ipl.csv"));

        FileWriter writer = new FileWriter("files/censored.csv");
