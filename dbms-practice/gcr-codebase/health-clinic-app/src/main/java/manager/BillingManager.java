...
public class BillingManager {
    public void generateBill(Bill bill, double consulationFee, double[] additionalCharges) throws ClinicException, SQLException{
        String sql1 = """
                INSERT INTO bills
        ...
        try(Connection connection = DBconnection.getConnection()){
            ...
            try(PreparedStatement ps1 = connection.prepareStatement(sql1, PreparedStatement.RETURN_GENERATED_KEYS)){
                ...
                try(PreparedStatement ps2 = connection.prepareStatement(sql2)){
                    ps2.setInt(1, billId);
                    ps2.setString(2, "Consulation Fee");
                    ps2.setDouble(3, consulationFee);
                    ps2.addBatch();
